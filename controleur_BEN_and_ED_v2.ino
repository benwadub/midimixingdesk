...
Bankable::CCPotentiometer fx [] = {
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(0), {83, CHANNEL_1}},//reverb send
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(1), {83, CHANNEL_2}},
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(2), {83, CHANNEL_3}},
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(3), {83, CHANNEL_4}},
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(4), {83, CHANNEL_5}},
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(5), {83, CHANNEL_6}},
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(6), {83, CHANNEL_7}},
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(7), {83, CHANNEL_8}},
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(15), {82, CHANNEL_1}},//delay send
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(14), {82, CHANNEL_2}},
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(13), {82, CHANNEL_3}},
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(12), {82, CHANNEL_4}},
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(11), {82, CHANNEL_5}},
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(10), {82, CHANNEL_6}},
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(9), {82, CHANNEL_7}},
  {{bank, BankType::CHANGE_ADDRESS},mux4.pin(8), {82, CHANNEL_8}},
};
